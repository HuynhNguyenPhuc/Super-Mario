...
class Victory(LoadScreen):
    ...
    def read_score_from_file(self, filename="resources/score.txt"):
        with open(filename, 'r') as file:
            score = int(file.read())
        return int(score)

    def save_score_to_file(self, score, filename="resources/score.txt"):
    ...
    def set_info_state(self):
        ...
        max_score = self.read_score_from_file()
        if score > max_score:
            self.save_score_to_file(score)
        return c.VICTORY
